      ...
      >
          ...
          >
            <div className="z-20 text-white flex justify-center items-center h-screen">
              <div className="content space-y-5 text-center">
                <h2 className="text-7xl text-prime">Art Of Cooking</h2>
                <h3 className="text-9xl">All About Passion</h3>
        ...
        <SwiperSlide>
          ...
          >
            <div className="z-20 text-white flex justify-center items-center h-screen">
              <div className="content space-y-5 text-center">
                <h2 className="text-7xl text-prime">Taste Of SR Hostel</h2>
                <h3 className="text-9xl">Started Since</h3>
        ...
        <SwiperSlide>
          ...
          >
            <div className="z-20 text-white flex justify-center items-center h-screen">
              <div className="content space-y-5 text-center">
                <h2 className="text-7xl text-prime">Welcome To</h2>
                <h3 className="text-9xl">
                  <span className="text-prime">SR</span> <span>Hostel</span>
                </h3>
                <NavLink to="/menu" className="bg-prime btn text-xl">
                  Menu
                </NavLink>
              </div>
            </div>
